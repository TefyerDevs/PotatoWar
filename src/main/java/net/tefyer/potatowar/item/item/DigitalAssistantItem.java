...
import net.tefyer.potatowar.procedures.DigitalAssistantItemInInventoryTickProcedure;
import net.tefyer.potatowar.procedures.DigitalAssistantRightclickedProcedure;

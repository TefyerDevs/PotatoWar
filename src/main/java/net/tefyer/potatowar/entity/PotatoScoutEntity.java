...
public class PotatoScoutEntity extends Monster {
	public PotatoScoutEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PotatowarModEntities.POTATO_SCOUT.get(), world);
	}

	public PotatoScoutEntity(EntityType<PotatoScoutEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);

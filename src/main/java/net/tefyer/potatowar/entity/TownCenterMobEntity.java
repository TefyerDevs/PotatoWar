...
import net.tefyer.potatowar.procedures.TownCenterUpdateTickProcedure;
import net.tefyer.potatowar.procedures.TownCenterMobRightClickedOnEntityProcedure;
import net.tefyer.potatowar.procedures.TownCenterMobOnInitialEntitySpawnProcedure;
...
public class TownCenterMobEntity extends Monster {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		TownCenterMobOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TownCenterMobRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		TownCenterUpdateTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}

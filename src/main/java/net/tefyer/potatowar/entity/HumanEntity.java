...
import net.tefyer.potatowar.procedures.TradeStartedHumanProcedure;
import net.tefyer.potatowar.procedures.SetItemsHumanProcedure;
...
public class HumanEntity extends PathfinderMob {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		SetItemsHumanProcedure.execute(this);
		return retval;
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		TradeStartedHumanProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}

package net.mcreator.potatowar;
...
import net.mcreator.potatowar.init.PotatowarModTabs;
import net.mcreator.potatowar.init.PotatowarModSounds;
import net.mcreator.potatowar.init.PotatowarModPaintings;
...
@Mod("potatowar")
public class PotatowarMod {
	public static final Logger LOGGER = LogManager.getLogger(PotatowarMod.class);

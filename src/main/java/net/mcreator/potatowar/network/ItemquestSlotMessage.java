...
public class ItemquestSlotMessage {
	...
	public static void handler(ItemquestSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PotatowarMod.addNetworkMessage(ItemquestSlotMessage.class, ItemquestSlotMessage::buffer, ItemquestSlotMessage::new, ItemquestSlotMessage::handler);
	}
}

...
public class DownpourIsleTrunkDecorator extends TrunkVineDecorator {
	public static Codec<DownpourIsleTrunkDecorator> CODEC = Codec.unit(DownpourIsleTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("downpour_isle_tree_trunk_decorator", DECORATOR_TYPE));
	}

...
package net.mcreator.potatowar.world.features.treedecorators;
...
public class DownpourIsleFruitDecorator extends CocoaDecorator {
	public static Codec<DownpourIsleFruitDecorator> CODEC = Codec.unit(DownpourIsleFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("downpour_isle_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public DownpourIsleFruitDecorator() {
		super(0.2f);
	}

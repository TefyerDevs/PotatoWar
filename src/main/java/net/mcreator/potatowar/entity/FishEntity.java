...
import net.mcreator.potatowar.procedures.FishEntityIsHurtProcedure;
...
public class FishEntity extends Monster {
	...
	public FishEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PotatowarModEntities.FISH.get(), world);
	}

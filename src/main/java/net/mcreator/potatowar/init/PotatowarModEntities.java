...
import net.mcreator.potatowar.entity.UnknownEntity;
import net.mcreator.potatowar.entity.TownCenterMobEntity;
import net.mcreator.potatowar.entity.ScoutLeaderEntity;
import net.mcreator.potatowar.entity.RemnantEntity;
import net.mcreator.potatowar.entity.Remnant6Entity;
import net.mcreator.potatowar.entity.Remnant5Entity;
import net.mcreator.potatowar.entity.Remnant4Entity;
import net.mcreator.potatowar.entity.Remnant3Entity;
import net.mcreator.potatowar.entity.Remnant2Entity;
import net.mcreator.potatowar.entity.RaidLeaderEntity;
import net.mcreator.potatowar.entity.Prototype1Entity;
import net.mcreator.potatowar.entity.ProtoDefenderEntity;
import net.mcreator.potatowar.entity.PotatoScoutEntity;
import net.mcreator.potatowar.entity.PotatoOutlawEntity;
import net.mcreator.potatowar.entity.PotatoMilitaryEntity;
import net.mcreator.potatowar.entity.PotatoMilitaEntity;
import net.mcreator.potatowar.entity.PotatoManEntity;
import net.mcreator.potatowar.entity.PotatoKnightEntity;
import net.mcreator.potatowar.entity.PotatoArcherEntity;
import net.mcreator.potatowar.entity.MilitaryTrainerEntity;
import net.mcreator.potatowar.entity.LostHazzyEntity;
import net.mcreator.potatowar.entity.HumanScoutEntity;
import net.mcreator.potatowar.entity.HumanOutlawEntity;
import net.mcreator.potatowar.entity.HumanMilitaryEntity;
import net.mcreator.potatowar.entity.HumanMilitaEntity;
import net.mcreator.potatowar.entity.HumanKnightEntity;
import net.mcreator.potatowar.entity.HumanEntity;
import net.mcreator.potatowar.entity.HazzycloneEntity;
import net.mcreator.potatowar.entity.GlitchEntity;
import net.mcreator.potatowar.entity.FriedPotatoManEntity;
import net.mcreator.potatowar.entity.FlyingTeddyEntity;
import net.mcreator.potatowar.entity.FishEntity;
import net.mcreator.potatowar.entity.CorruptedplayerEntity;

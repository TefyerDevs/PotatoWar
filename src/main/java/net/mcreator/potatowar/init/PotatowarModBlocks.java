...
import net.mcreator.potatowar.block.PotatoBlockBlock;
import net.mcreator.potatowar.block.Oddpotato4Block;
import net.mcreator.potatowar.block.Oddpotato3Block;
import net.mcreator.potatowar.block.Oddpotato2Block;
import net.mcreator.potatowar.block.OddPotatoPlantStg1Block;
import net.mcreator.potatowar.block.ForgottenWorldsPortalBlock;
import net.mcreator.potatowar.block.DigitalWorldPortalBlock;
import net.mcreator.potatowar.block.DigitalBlockBlock;
